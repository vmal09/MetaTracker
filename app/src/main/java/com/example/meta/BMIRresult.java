...
public class BMIRresult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCalBMI=findViewById(R.id.buttonCalBMI);
        ...
        findViewById(R.id.buttonCalBMI).setOnClickListener(new View.OnClickListener() {
            @Override
