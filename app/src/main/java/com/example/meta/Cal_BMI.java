    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mmale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mmale.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.gender_selected));
        ...
        mfemale.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mfemale.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.gender_selected));
        ...
        mcalculatebmi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(intweight==0|| intweight<0)
                {
                    ...
                    Intent intent = new Intent(Cal_BMI.this, BMIRresult.class);
